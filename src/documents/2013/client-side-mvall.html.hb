...
acreditamos que a abordagem seguida por ela não é tão efetiva quanto poderia ser: ainda é necessário escrever muito código para configurar a manipulação dos dados e a sua relação com a interface.

Já as bibliotecas Envers e AngularJS apresentam uma abordagem declarativa bastante simples e parecem ser o caminho a se seguir para tratar desse problema.